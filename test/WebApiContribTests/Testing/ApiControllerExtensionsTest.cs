...
namespace WebApiContribTests.Testing
{
    ...
    public class ApiControllerExtensionsTest
    {
        ...
        public void ShouldAddRouteIfProvidedWhenConfigureIsInvoked()
        {
            ...
            controller.Configuration.Routes.Contains(route);
        }
        ...
        public void ShouldCreateRequestWhenConfigureIsInvokedPassingUriAndMethod()
        {
            ...
            controller.Request.Method.Equals(HttpMethod.Get);
            controller.Request.RequestUri.AbsoluteUri.Equals("http://localhost/test");
        }
